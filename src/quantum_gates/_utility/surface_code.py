...
class SaveStateFlag(Instruction):
            """Custom marker instruction for simulators."""
            def __init__(self, label=None):
                super().__init__("save_state_flag", 1, 0, [label])
                # Mark as opaque: no decomposition, no synthesis
